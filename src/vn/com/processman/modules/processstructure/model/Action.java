...
import domainapp.basics.model.meta.query.AttribExp;
import domainapp.basics.model.meta.query.QueryDef;
...
//    reflexive=true,dependsOn=true)
  ...
  @QueryDef(clazz=Action.class,
      attributeExps={
        @AttribExp(attrib=Action.A_code, op=Op.NOTEQ, value=MetaConstants.NullValue)
      }
  )
  ...
  @DAssoc(ascName = Association_ActionPreconditions, role = "action", 
      ...
      associate = @Associate(type = BooleanExpression.class, cardMin = 0, cardMax = MetaConstants.CARD_MORE))
