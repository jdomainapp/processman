...
public class OrgUnit {
  ...
  @DAssoc(ascName =Assoc_OrgUnitAndProcessApplication, role = "orgUnit", 
      ...
      associate = @Associate(type = ProcessApplication.class, cardMin = 1, cardMax = MetaConstants.CARD_MORE))
  ...
  @DAssoc(ascName = Assoc_OrgUnitCreateProcess, role = "orgUnit", 
      ascType = AssocType.One2Many, endType = AssocEndType.One, 
      associate = @Associate(type = Process.class, cardMin = 1, cardMax = MetaConstants.CARD_MORE))
