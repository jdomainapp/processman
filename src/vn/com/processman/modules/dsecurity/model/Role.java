 ...
 * @version 3.3
 */
@DClass(schema=MetaConstants.SECURITY_SCHEMA)
public class Role extends domainapp.basics.model.security.Role {
...
//    associate=@Associate(type=Action.class,cardMin=1,cardMax=MetaConstants.CARD_MORE),
...
//  private Collection<Action> actions;
  ...
  @DAssoc(ascName=Action.Association_RoleActions,role="role",
      ...
      associate=@Associate(type=Action.class,cardMin=0,cardMax=MetaConstants.CARD_MORE)) 
  private Collection<Action> actions;
  ...
  @DAssoc(ascName=Assoc_RoleAndRolePerfProcess,role="role",
      ascType=AssocType.One2Many,endType=AssocEndType.One,
      associate=@Associate(type=RolePerfProcess.class,cardMin=0,cardMax=MetaConstants.CARD_MORE)) 
   ...
   * @version 3.3
   */
  public static boolean isProcessUserRole(domainapp.basics.model.security.Role role) {
   ...
   * @version 3.3
   */
  public static boolean isProcessAdminRole(domainapp.basics.model.security.Role role) {
    String roleName = role.getName();
   ...
   * @version 3.3
   */
  public static boolean isTeacherRole(domainapp.basics.model.security.Role role) {
    String roleName = role.getName();
